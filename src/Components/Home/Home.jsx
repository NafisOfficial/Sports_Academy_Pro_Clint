...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div className='w-10/12 text-center sm:text-right sm:ms-20 my-12'><button disabled={loading?true:false} className="btn bg-[#37B34A] text-white hover:text-white hover:bg-[#14693f] rounded-sm btn-sm"><Link to='/instructors' className='flex gap-2'>See all classes <FaLongArrowAltRight></FaLongArrowAltRight></Link></button></div>
        </div>
    );
};
