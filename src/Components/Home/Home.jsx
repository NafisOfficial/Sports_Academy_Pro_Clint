...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div className='w-10/12 text-center sm:text-right sm:ms-20 my-12'><Link to='/classes' ><button className="btn bg-[#37B34A] text-white hover:text-white hover:bg-[#14693f] rounded-sm btn-sm">See all classes</button></Link></div>
            ...
            <div className='w-10/12 text-center sm:text-right sm:ms-20 my-12'><Link to='/instructors' ><button className="btn bg-[#37B34A] text-white hover:text-white hover:bg-[#14693f] rounded-sm btn-sm">See all instructor</button></Link></div>
        </div>
    );
};
