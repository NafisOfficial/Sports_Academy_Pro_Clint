...
const Card = ({classesData}) => {


    const { _id,class_name, class_image,instructor_name, instructor_image, available_seats, price, enrolled, syllabus,status } = classesData
        ...
        <div>
            <div className="card w-80 bg-base-100 shadow-xl">
                ...
                <div className={available_seats?"card-body":"card-body bg-red-200"}>
                    ...
                    <p className='text-orange-400'>Status:{status}</p>
                    ...
                    <div className="card-actions flex justify-between items-center">
                        ...
                        <button  className="btn bg-[#37B34A] text-white hover:text-white hover:bg-[#14693f] rounded-1 btn-sm">Update</button>
                    </div>
                </div>
            </div>
        </div>
